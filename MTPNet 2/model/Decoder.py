...
from .Transformer import saliency_token_inference, edge_token_inference, token_TransformerEncoder, saliency_prompt_inference, edge_prompt_inference
...
class token_trans(nn.Module):
    ...
    def forward(self, fea, saliency_tokens, edge_tokens, task_prompt, num):
        ...
        fea, saliency_tokens, edge_tokens, fea_tmp, fea_s, task_prompt = self.encoderlayer(fea, 2*num)
        ...
        saliency_fea = self.saliency_prompt_pre(fea, task_prompt[:, :num, :], num)
        edge_fea = self.edge_prompt_pre(fea, task_prompt[:, num:, :], num)
...
class Decoder(nn.Module):
    ...
    def forward(self, fea_1_16, saliency_tokens, edge_tokens, fea_16, saliency_tokens_16, edge_tokens_16,
                saliency_fea_1_16, edge_fea_1_16, rgb_fea_1_8, rgb_fea_1_4, task_prompt1, num1):
        ...
        fea_1_8, saliency_tokens, edge_tokens, fea_8, saliency_tokens_8, edge_tokens_8, saliency_fea_1_8, edge_fea_1_8, task_prompt = self.token_pre_1_8(
            fea_1_8, saliency_tokens, edge_tokens, task_prompt1, num1)
        ...
        fea_1_4, saliency_tokens, edge_tokens, fea_4, saliency_tokens_4, edge_tokens_4, saliency_fea_1_4, edge_fea_1_4, task_prompt = self.token_pre_1_4(
            fea_1_4, saliency_tokens, edge_tokens, task_prompt1, num1)
        ...
        return [mask_1_16, mask_1_8, mask_1_4, mask_1_1], [edg_1_16, edg_1_8, edg_1_4, edg_1_1], [mask_1_16_s,
                                                                                                  ...
                                                                                                  mask_1_4_s,
                                                                                                  mask_1_1_s], [
            edg_1_16_s, edg_1_8_s, edg_1_4_s, edg_1_1_s], task_prompt, get